  ...
  <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4 ">
    ...
    <li class="nav-item dropdown no-arrow mx-1">
      <a class="nav-link dropdown-toggle" href="/admin/appliedleaves" id="alertsDropdown" role="button">
        ...
        <!-- Counter - Alerts -->
        <?php
$query = "SELECT leave_status FROM apply_leave where leave_status = :leave_status ORDER BY applied_at";
$stmt = $conn->prepare($query);
$stmt->execute(['leave_status' => 0]);
$data = $stmt->fetchAll();

if ($data) {
    echo '<span class="badge badge-danger badge-counter">' . count($data) . '</span>';
} else {
...
?>
    ...
    <li class="nav-item dropdown pe-3">
      <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
        ...
        <img class="img-profile rounded-circle" src="/frontend/assets/images/user2.jpg" alt="Profile"
      ...
      <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
        ...
        <!-- Logout -->
        <form action="/admin/logout" name="logout_form" method="post">
          <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>
